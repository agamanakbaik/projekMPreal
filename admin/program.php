...
<head>
    ...
    <style>
        ...
        .swiper-slide { display: flex; align-items: center; justify-content: center; background: #e5e7eb; }
        ...
        .swiper-button-next, .swiper-button-prev { color: #09AFB5; transform: scale(0.6); text-shadow: 0 0 2px white; }
        .swiper-pagination-bullet-active { background: #09AFB5; }
    </style>
</head>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-yellow-500">
                    ...
                    <form method="POST" class="flex gap-2">
                        <input type="number" name="no_wa_default" value="<?= $wa_default_db ?>" class="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:outline-none transition font-bold text-gray-700" placeholder="628xxx" required>
                        <button type="submit" name="update_wa" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg font-bold transition shadow-sm">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-purple-500">
                    <h2 class="text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                        <i class="fas fa-image text-purple-500 text-xl"></i> Banner Header Publik
                    </h2>
                    
                    <div class="w-full h-32 bg-gray-200 rounded-lg overflow-hidden mb-4 border border-gray-300 flex items-center justify-center relative">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="flex flex-col gap-3">
                        <input type="file" name="header_img" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 transition cursor-pointer border rounded-lg" required>
                        <button type="submit" name="simpan_header" class="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg font-bold transition shadow-sm text-sm">
                            <i class="fas fa-upload mr-2"></i> Upload Banner
                        </button>
                    </form>
                    <p class="text-[10px] text-gray-400 mt-2 italic">*Gambar ini akan menjadi background header di halaman Program publik.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg h-fit border-t-4 border-primary">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" class="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-primary/50 focus:outline-none transition" required placeholder="Contoh: Paket Usaha Reseller">
                        </div>
                        
                        <div class="mb-4">
                            <label class="block text-sm font-bold text-gray-700 mb-1">No. WhatsApp Admin (Opsional)</label>
                            <input type="number" name="no_hp" class="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-primary/50 focus:outline-none transition" placeholder="62812xxxx">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" rows="6" class="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-primary/50 focus:outline-none transition" required placeholder="Jelaskan detail program di sini..."></textarea>
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-bold text-gray-700 mb-1">Foto Ilustrasi</label>
                            <input type="file" name="gambar[]" multiple class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/20 transition cursor-pointer" required>
                            <p class="text-xs text-gray-400 mt-1">*Bisa pilih banyak foto sekaligus.</p>
                        </div>

                        <button type="submit" name="simpan" class="w-full bg-primary hover:bg-primaryHover text-white font-bold py-2.5 rounded-lg transition shadow-md transform hover:-translate-y-0.5">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 overflow-hidden border border-gray-100 flex flex-col md:flex-row min-h-[250px]">
                        ...
                        <div class="w-full md:w-5/12 bg-gray-200 relative h-64 md:h-auto overflow-hidden">
                            ...
                            <?php else: ?>
                                <div class="h-full flex items-center justify-center text-gray-400"><i class="fas fa-image text-4xl"></i></div>
                            <?php endif; ?>
                        </div>
                        
                        <div class="w-full md:w-7/12 p-5 flex flex-col">
                            <div class="flex justify-between items-start">
                                <h3 class="text-xl font-bold text-gray-800 mb-1 leading-tight group-hover:text-primary transition">
                                    <?= $p['judul'] ?>
                                </h3>
                                <button onclick="hapusProgram(<?= $p['id'] ?>)" 
                                   class="text-red-400 hover:text-red-600 p-2 bg-red-50 rounded hover:bg-red-100 transition" title="Hapus">
